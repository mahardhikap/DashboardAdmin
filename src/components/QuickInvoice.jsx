    ...
    <div className="p-2">
      ...
      <div className="grid grid-cols-2">
        <div className="ps-2 pe-1">
          <div className="my-2">
            <label htmlFor="" className="text-[#064061]">Customer name</label>
            <input
          ...
          <div className="my-2">
            <label htmlFor="" className="text-[#064061]">Item name</label>
            <input
        ...
        <div className="ps-1 pe-2">
          <div className="my-2">
            <label htmlFor="" className="text-[#064061]">Customer email</label>
            <input
          ...
          <div className="my-2">
            <label htmlFor="" className="text-[#064061]">Item mount</label>
